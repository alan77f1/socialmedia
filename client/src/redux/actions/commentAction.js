  ...
  async (dispatch) => {
    ...
    try {
      ...
      const msg = {
        ...
        text: newComment.reply ? 'đã nhắc đến bạn trong bình luận.' : 'đã bình luận vào bài viết của bạn.',
  ...
  async (dispatch) => {
    ...
    try {
      deleteArr.forEach((item) => {
        ...
        const msg = {
          id: item._id,
          text: comment.reply ? 'đã nhắc đến bạn trong bình luận.' : 'đã bình luận vào bài viết của bạn.',
